...
import time
import datetime
from utils import return_monday

def first_lights_preprocess(light_alarms: pd.DataFrame, min_date = "1982-01-04", max_date = "2023-04-04") -> pd.DataFrame:
    """
...
def first_eboxes_preprocess(eboxes_alarms: pd.DataFrame, min_date = "1982-01-04", max_date = "2023-04-04") -> pd.DataFrame:
    """
    Performs basic preprocessing on the raw data of alarms such as filtering the errors that
    we want to predict ("lightcomm", "lighterr"), remove useless columns, parse dates and 
    eliminate dates out of a defined range.
